...
static const st_driver_group_t all_drv_groups[] = {
    ...
    {.module_id = MODULE_HSCIF2, .group = ADD_GROUP(hscif2_grp)},
    {.module_id = MODULE_HSCIF3, .group = ADD_GROUP(hscif3_grp)},
    {.module_id = MODULE_SCIF0, .group = ADD_GROUP(scif0_grp)},
    {.module_id = MODULE_SCIF1, .group = ADD_GROUP(scif1_grp)},
    {.module_id = MODULE_SCIF3, .group = ADD_GROUP(scif3_grp)},
    {.module_id = MODULE_SCIF4, .group = ADD_GROUP(scif4_grp)},
