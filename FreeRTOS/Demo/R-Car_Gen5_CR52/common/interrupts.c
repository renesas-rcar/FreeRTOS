...
#define STAT_UCIE(x)            (0x18A00000U + 0x8780U + ((uint32_t)(x) * 0x28U))
#define STAT_UCIE_ERROR(x)      (0x18A00000U + 0x87D0U + ((uint32_t)(x) * 0x4U))
#define MASK_UCIE(x)            (0x18A00000U + 0x9780U + ((uint32_t)(x) * 0x28U))
#define MASK_UCIE_ERROR(x)      (0x18A00000U + 0x97D0U + ((uint32_t)(x) * 0x4U))
