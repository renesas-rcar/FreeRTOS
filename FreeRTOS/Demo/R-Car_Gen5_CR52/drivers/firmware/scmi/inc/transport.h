...
struct scmi_transport_api {
	int (*init)(const struct scmi_dev *transport);
	int (*send_message)(const struct scmi_dev *transport,
			    struct scmi_channel *chan,
			    struct scmi_message *msg);
	int (*setup_chan)(const struct scmi_dev *transport,
			  struct scmi_channel *chan,
			  bool tx);
	int (*read_message)(const struct scmi_dev *transport,
			    struct scmi_channel *chan,
			    struct scmi_message *msg);
 ...
 * setup() function.
 *
 * @param transport pointer to the scmi_dev structure for the
 * transport layer
...
scmi_transport_request_channel(const struct scmi_dev *transport,
			       uint32_t proto, bool tx)
{
 ...
 */
static inline int scmi_transport_init(const struct scmi_dev *transport)
{
	const struct scmi_transport_api *api =
		(const struct scmi_transport_api *)transport->api;
 ...
 * @retval negative errno code if failure
 */
static inline int scmi_transport_setup_chan(const struct scmi_dev *transport,
					    struct scmi_channel *chan,
					    bool tx)
{
	const struct scmi_transport_api *api =
 ...
 * @retval negative errno code if failure
 */
static inline int scmi_transport_send_message(const struct scmi_dev *transport,
					      struct scmi_channel *chan,
					      struct scmi_message *msg)
{
	const struct scmi_transport_api *api =
 ...
 * @retval negative errno code if failure
 */
static inline int scmi_transport_read_message(const struct scmi_dev *transport,
					      struct scmi_channel *chan,
					      struct scmi_message *msg)
{
	const struct scmi_transport_api *api =
 ...
 * @retval negative errno code if failure
 */
static inline bool scmi_transport_channel_is_free(const struct scmi_dev *transport,
						  struct scmi_channel *chan)
{
	const struct scmi_transport_api *api =
		(const struct scmi_transport_api *)transport->api;
