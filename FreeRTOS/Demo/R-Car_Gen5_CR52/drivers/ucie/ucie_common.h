...
#define UCIE_AXI_BASE(n)    (0xD8000000U + ((uint32_t)(n)) * 0x1000000U)
#define UCIE_APB_BASE(n)    (0xDC000000U + ((uint32_t)(n)) * 0x1000000U)
...
/* PF0_HDMA_CAP */
#define HDMA_CH_BLOCK_SIZE          (0x800U)
#define HDMA_RW_BLOCK_SIZE          (0x400U)

#define HDMA_EN_OFF                 (0x00U)
#define HDMA_DOORBELL_OFF           (0x04U)
#define HDMA_ELEM_PF_OFF            (0x08U)
#define HDMA_LLP_LOW_OFF            (0x10U)
#define HDMA_LLP_HIGH_OFF           (0x14U)
#define HDMA_CYCLE_OFF              (0x18U)
#define HDMA_XFERSIZE_OFF           (0x1CU)
#define HDMA_SAR_LOW_OFF            (0x20U)
#define HDMA_SAR_HIGH_OFF           (0x24U)
#define HDMA_DAR_LOW_OFF            (0x28U)
#define HDMA_DAR_HIGH_OFF           (0x2CU)
#define HDMA_WATERMARK_EN_OFF       (0x30U)
#define HDMA_CONTROL1_OFF           (0x34U)
#define HDMA_FUNC_NUM_OFF           (0x38U)
#define HDMA_QOS_OFF                (0x3CU)
#define HDMA_STATUS_OFF             (0x80U)
#define HDMA_INT_STATUS_OFF         (0x84U)
#define HDMA_INT_SETUP_OFF          (0x88U)
#define HDMA_INT_CLEAR_OFF          (0x8CU)
#define HDMA_MSI_STOP_LOW_OFF       (0x90U)
#define HDMA_MSI_STOP_HIGH_OFF      (0x94U)
#define HDMA_MSI_WATERMARK_LOW_OFF  (0x98U)
#define HDMA_MSI_WATERMARK_HIGH_OFF (0x9CU)
#define HDMA_MSI_ABORT_LOW_OFF      (0xA0U)
#define HDMA_MSI_ABORT_HIGH_OFF     (0xA4U)
#define HDMA_MSI_MSGD_OFF           (0xA8U)

/* PF0_ATU_CAP */
#define IATU_BLOCK_SIZE             (0x200U)
#define IATU_INBOUND_OFFSET         (0x100U)

#define IATU_REGION_CTRL_1_OFF      (0x00U)
#define IATU_REGION_CTRL_2_OFF      (0x04U)
#define IATU_LWR_BASE_ADDR_OFF      (0x08U)
#define IATU_UPPER_BASE_ADDR_OFF    (0x0CU)
#define IATU_LIMIT_ADDR_OFF         (0x10U)
#define IATU_LWR_TARGET_ADDR_OFF    (0x14U)
#define IATU_UPPER_TARGET_ADDR_OFF  (0x18U)
#define IATU_REGION_CTRL_3_OFF      (0x1CU)
#define IATU_UPPR_LIMIT_ADDR_OFF    (0x20U)
